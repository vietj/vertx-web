...
public class GraphQLInputDeserializerTest {
  ...
  public void testSingle() {
    ...
    GraphQLInput graphQLInput = JsonFactory.factory.fromBuffer(query.toBuffer(), GraphQLInput.class);
  ...
  public void testBatch() {
    ...
    GraphQLInput graphQLInput = JsonFactory.factory.fromBuffer(batch.toBuffer(), GraphQLInput.class);
